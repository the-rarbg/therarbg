              ...
              data1.map((item, index) => {
                return (
                  <div className='relative' key={index}>
                    <div key={index} onClick={() => router.push(`/get-posts/category:${item?.cat}?time=${item?.time}`)} className={`cursor-pointer w-[150px] md:w-[195px] h-[115px] md:pl-[26px] md:pr-[161px] pt-2 pb-16 bg-off-white/10 rounded-lg border-off-white/30 flex-col justify-start items-center md:items-start gap-3.5 inline-flex hover:bg-primary/10 border-[1px] hover:border-primary/50 group `}>
