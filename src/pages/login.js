  ...
  return (
    <div className='flex h-[90vh] justify-center items-center'>
      ...
      <div className='flex-colomn w-[90%] text-center'>
        ...
        <button className='px-[50px] py-[0.35rem] bg-primary/10 text-primary border-primary my-4 text-md hover:bg-primary/30' style={{border:"solid 0.5px",fontWeight:"400"}}  type="submit" >Login</button>
        </form>
